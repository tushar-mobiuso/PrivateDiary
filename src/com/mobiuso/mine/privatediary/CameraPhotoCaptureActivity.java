...
public class CameraPhotoCaptureActivity extends Activity {
    ...
    CameraPhotoCaptureActivity CameraActivity = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public static String convertImageUriToFile (Uri imageUri, Activity activity)  {
	    ...
	    public class LoadImagesFromSDCard  extends AsyncTask<String, Void, Void> {
	        ...
	        private ProgressDialog Dialog = new ProgressDialog(CameraPhotoCaptureActivity.this);
	                ...
	                try {
	                	...
	                	*/
	                    ...
	                    if (bitmap != null) {
	                        ...
	                        newBitmap = Bitmap.createScaledBitmap(bitmap, 370, 370, true); 
//	                        newBitmap = bitmap; 
